...
У данного модуля/class есть 2 функции(публичных)- ехать на расстояние и заправка.
Функция по заправке принимает модуль/class gasoline station. В этом модуле 1 функция-
